package com.rightkarma.javabasic.generics.bounds;

import com.rightkarma.javabasic.generics.common.Person;
import com.rightkarma.javabasic.generics.common.YoungPerson;
...
//	final Person ram=new Person(50, "Ram");
	...
	public void testOrderOfSaveAndGet() {
		...
		assertEquals(don, g.get()); // last saved person should come out.
		assertEquals(tom, g.get()); // last saved person should come out.
	}
